...
class Region(object):
	...
	def update(self):
		...
		#check custom louis table exist or not
		import globalVars
		clt = os.path.join(brailleTables.TABLES_DIR, 'custom_' +config.conf["braille"]["translationTable"])
		olt = os.path.join(brailleTables.TABLES_DIR, config.conf["braille"]["translationTable"])
